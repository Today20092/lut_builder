...
const bundle = await build({
  ...
  stdin: {
    contents: `
      export { App, ColorPicker, ExposureGraph, displayPreviewOverlayAt, overlayForExposure, previewColorAt, previewOverlayAt } from "./src/App.tsx";
...
const { App, ColorPicker, ExposureGraph, displayPreviewOverlayAt, overlayForExposure, previewColorAt, previewOverlayAt, React, act, createRoot } = await import(pathToFileURL(bundlePath).href)
